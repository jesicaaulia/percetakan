...
$_SESSION['msg']="Gambar produk berhasil diupdate !!";
...
<head>
	...
	<title>Admin| Update Gambar Produk</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Gambar saat ini produk1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Gambar baru produk1</label>
<div class="controls">
