...
<head>
	...
	<title>Admin| Sub Kategori</title>
...
<div class="controls">
<input type="text" ="Enter SubCategory Name"  name="subcategory" class="span8 tip" required>
</div>
</div>
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn">Buat</button>
											</div>
										</div>
									</form>
							</div>
