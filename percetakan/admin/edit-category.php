...
$_SESSION['msg']="Kategori diupdate !!";
...
<div class="controls">
<input type="text" placeholder="Masukkan nama kategori"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
