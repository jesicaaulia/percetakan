...
<html lang="en">
	<head>
	    ...
	    <title>PERCETAKAN CV.GLORIA SIMPANG USU | Home Page</title>
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">partai besar & kecil</h4>
						</div>
					</div>
					<h6 class="text">Dilayani tanpa minimum order dengan kualitas terbaik </h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Penawaran Khusus</h4>
						</div>
					</div>
					<h6 class="text">Penawaran harga terbaik dengan diskon 5% untuk pembelian pertama kali  </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Dekorasi</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
