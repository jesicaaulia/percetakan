...
<head>
	...
	<title>Admin| Edit Sub Kategori</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nama Sub Kategori</label>
<div class="controls">
<input type="text" placeholder="Masukkan nama sub kategori"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
