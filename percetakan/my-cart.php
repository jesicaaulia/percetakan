...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rp"." ".$row['shippingCharge']; ?>,-</span></td>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total Harga  : <span class="inner"><?php echo "Rp"." " .$_SESSION['tp']="$totalprice". ",-"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">CHEKOUT PROSES</button>
