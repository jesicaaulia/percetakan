...
<div class="control-group">
<label class="control-label" for="basicinput">Gambar saat ini produk2</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Gambar baru produk2</label>
<div class="controls">
